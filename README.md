...
## Docker notes
```
docker build -t petclinic-rest:v1 .
docker build -t petclinic-web:v1 . 

docker run --rm -d --name petclinic-rest -p 9966:9966 petclinic-rest:v1 
docker run --rm -d --name petclinic-web -p 4200:80 petclinic-web:v1 
```
## Further help
